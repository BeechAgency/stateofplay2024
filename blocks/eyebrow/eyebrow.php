...
$template = array(
	array('core/heading', array(
		'level' => 6,
		'content' => '<svg xmlns="http://www.w3.org/2000/svg" width="6" height="6" fill="currentColor" viewBox="0 0 6 6"><circle id="Ellipse_55" data-name="Ellipse 55" cx="3" cy="3" r="3"/></svg> Yolo',
	))
);
?>
<!--
